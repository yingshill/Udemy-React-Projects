...
class IndecisionApp extends React.Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        if (prevState.options.length !== this.state.options.length) {
            const json = JSON.stringify(this.state.options)                    // when user type in something, storage it behind the scene, it's called updated, then get the date from  the local storage and let it render on the screen 
